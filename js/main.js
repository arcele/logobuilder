...
(function () {
     ...
     var backStyles = ['blank', 'striped', 'diag', 'exed', 'habs', 'roundel', 'dots'];
	 ...
	 for(var i = 0; i < count; i++) {
		 ...
		 {
		     points: (i % 2 == 0) ? 
			 [0, 0, Logo.kinetic.stage.getWidth(), Logo.kinetic.stage.getHeight()] :
			 [0, Logo.kinetic.stage.getHeight(), Logo.kinetic.stage.getWidth(), 0],
		     stroke: Logo.stripeColor,
